...
Wordfish is a Universal Chess Interface (UCI) engine derived from Stockfish. It retains the parent engine's search strength while adding dual-network neural evaluation, a persistent experience store, and configurable Monte Carlo search. The current release is **Wordfish-4.0.1-260126**, tuned around the latest Stockfish evaluation networks. The codebase is engineered for reproducible testing, efficient NUMA-aware threading, and transparent diagnostics.

## What's new in 4.0.1-260126

- Rebranded the engine to **Wordfish-4.0.1-260126** and expanded architecture-aware suffixes so GUI search listings display `Wordfish-4.0.1-260126-sse41popcnt` (SSE4.1/POPCNT builds), `Wordfish-4.0.1-260126-avx2` (AVX2 builds), `Wordfish-4.0.1-260126-bmi2` (BMI2 builds), `Wordfish-4.0.1-260126-FMA3` (FMA3 builds), or `Wordfish-4.0.1-260126-avx512` (AVX-512 builds) alongside the base name.
