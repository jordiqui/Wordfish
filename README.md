...
**Versión Wordfish-3.10-011125**

Este build se identifica como `Wordfish-3.10-011125` en la consola UCI y el binario predeterminado se distribuye como `Wordfish-3.10-011125`.
...
identifier if it is not already present (for example, `Wordfish-3.10-011125`),
