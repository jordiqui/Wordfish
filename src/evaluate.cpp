...
Value Eval::evaluate(const Eval::NNUE::Network&    networks,
    ...
    optimism += optimism * std::int64_t(nnueComplexity) / 468;
    nnue -= nnue * std::int64_t(nnueComplexity) / 18000;

    int material = 535 * pos.count<PAWN>() + pos.non_pawn_material();
    int v        = (nnue * std::int64_t(77777 + material)
                    + optimism * std::int64_t(7777 + material)) / 77777;
